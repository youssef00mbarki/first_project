...
class Database
{
     ...
     * @param null $prefix
     */
	public function __construct($driver = 'mysql', $host = 'localhost', $user = 'root', $pass = '', $name = 'site', $charset = 'utf8', $port = 3306, $prefix = null)
	{
	 ...
	 *
	 * @param string|array $table    - the name of the src table we are retreiving the rows from
	 ...
	 *
	 * @param string $table          - the name of the src table we are adding row to
	 ...
	 *
	 * @param $table  - the name of the src table we are deleting the rows from
